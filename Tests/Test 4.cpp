...
/* USER CODE END MX_GPIO_Init_1 */
 ...
 HAL_GPIO_WritePin(GPIOC, GPIO_PIN_0|GPIO_PIN_1|LED_Pin|SOUND_Pin, GPIO_PIN_RESET);
 /*Configure GPIO pin Output Level */
 HAL_GPIO_WritePin(GPIOA, GPIO_PIN_0|GPIO_PIN_1|GPIO_PIN_4|GPIO_PIN_5
                         |GPIO_PIN_6, GPIO_PIN_RESET);
 /*Configure GPIO pin Output Level */
 HAL_GPIO_WritePin(GPIOB, D1_Pin|D4_Pin|D2_Pin|D3_Pin, GPIO_PIN_RESET);
 /*Configure GPIO pins : PC0 PC1 LED_Pin SOUND_Pin */
 GPIO_InitStruct.Pin = GPIO_PIN_0|GPIO_PIN_1|LED_Pin|SOUND_Pin;
